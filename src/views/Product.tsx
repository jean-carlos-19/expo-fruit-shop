      ...
      >
        ...
        <View style={{ height: 165 }}>
          <Text style={{ color: theme.text }} className="tracking-wider py-3">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, enim ex
            explicabo tenetur dolorem fuga delectus id! Eius est temporibus,
            illum eveniet quibusdam vel tempore expedita eos cumque iure quo
            fuga sunt voluptate aliquam ea, tenetur sint sequi incidunt in
            dolores quod deserunt! Dolores quia aliquid maxime similique,
            dolorum ducimus?
          </Text>
        </View>
